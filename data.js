...
const workoutDays = [
    ...
    exercises: [
      {
        ...
        cues: 'Elbows 45° • Neutral spine • Inhale down • Exhale up'
      },
      {
        name: 'Dumbbell Shoulder Press',
        sets: '3×8–10', rpe: 'RPE 7', weight: '15 lb',
        video: 'https://youtu.be/qEwKCR5JCog',
        cues: 'Soft elbows • Core tight • Inhale start • Exhale overhead'
      },
      {
      ...
      },
      {
        ...
        cues: 'No swing • Shoulders level • Inhale down • Exhale lift'
      },
      {
        name: 'Close-Grip Push-ups',
        sets: '3×12–15', rpe: 'RPE 7', weight: 'BW',
        video: 'https://youtu.be/_6NRxf8dMVk',
        cues: 'Hips inline • Elbows 45° • Inhale down • Exhale up'
      },
    ]
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        cues: 'Hip hinge • Neutral back • Inhale down • Exhale hip thrust'
      },
      {
        name: 'Step-ups (bench)',
        sets: '3×10–12', rpe: 'RPE 8', weight: '15 lb',
      ...
      },
      {
        ...
        cues: 'Hips level • Feet placement • Inhale down • Exhale squeeze'
      },
      {
        name: 'Plank Hold',
        sets: '3×45 sec', rpe: 'RPE 8', weight: 'BW',
        video: 'https://youtu.be/ASdvN_XEl_c',
        cues: 'Body straight • Neutral neck • Steady inhale/exhale'
      },
    ]
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        cues: 'Torso square • No shrug • Inhale down • Exhale row'
      },
      {
        name: 'Dumbbell Curls',
        sets: '3×12–15', rpe: 'RPE 8', weight: '10 lb',
        video: 'https://youtu.be/ykJmrZ5v0Oo',
        cues: 'Elbows locked • No swing • Inhale down • Exhale curl'
      },
      {
        name: 'Reverse Flys',
        sets: '3×12–15', rpe: 'RPE 8', weight: '10 lb',
        video: 'https://youtu.be/ea7qmaN9nDk',
        cues: 'Slight elbow bend • Controlled arc • Inhale down • Exhale up'
      },
      {
        name: 'Pull-ups',
        sets: '3×max', rpe: 'RPE 8', weight: 'BW',
  ...
  },
  {
    ...
    exercises: [
      {
        name: 'Jog/Run Tips',
        sets: '25–30 min', rpe: 'Moderate', weight: '',
        video: 'https://youtu.be/kVnyY17VS9Y',
        cues: 'Midfoot strike • Short steps • Inhale nose • Exhale mouth'
      },
      {
        name: 'Hanging Knee Raises',
        sets: '3×12–15', rpe: 'RPE 8', weight: 'BW',
        video: 'https://youtu.be/hdng3Nm1x_E',
        cues: 'No swing • Tuck pelvis • Inhale down • Exhale raise'
      },
      {
        name: 'Russian Twists',
        sets: '3×15–20/side', rpe: 'RPE 8', weight: '5 – 10 lb',
        video: 'https://youtu.be/wkD8rjkodUI',
        cues: 'Chest up • Feet stable • Inhale turn • Exhale turn'
      },
      {
        name: 'Side Planks',
        sets: '3×30 sec ea', rpe: 'BW', weight: '',
        video: 'https://youtu.be/K2VljzCC16g',
        cues: 'Hips stacked • Neutral spine • Inhale deep • Exhale hold'
      },
    ]
  },
  {
    ...
    exercises: [
      {
        ...
        cues: 'Neutral spine • Slight knees • Inhale down • Exhale standing'
      },
      {
        name: 'Push-ups',
        sets: '3×15', rpe: 'RPE 8', weight: 'BW',
        video: 'https://youtu.be/IODxDxX7oi4',
        cues: 'Elbows 45° • Body straight • Inhale down • Exhale up'
      },
    ]
  },
  {
    ...
    exercises: [
      {
        ...
        sets: '1′ sprint/2′ jog ×6–7', rpe: '80–90%', weight: '',
        video: 'https://youtu.be/9YUCry7eML4',
        cues: 'Form holds • Quick drive • Inhale prep • Exhale sprint'
      },
      {
        name: 'Jump Rope',
        sets: '3×1 min', rpe: 'RPE 8', weight: 'BW',
        video: 'https://youtu.be/1BZM2Vre5oc',
        cues: 'Light bounce • Wrists turn • Inhale/exhale steady'
      },
      {
        name: 'Burpees',
        sets: '3×12', rpe: 'RPE 8', weight: 'BW',
        video: 'https://youtu.be/TU8QYVW0gDU',
        cues: 'Plank form • Full rep • Inhale squat • Exhale jump'
      },
      {
        name: 'Mountain Climbers',
        sets: '3×30 sec', rpe: 'RPE 8', weight: 'BW',
        video: 'https://youtu.be/nmwgirgXLYM',
        cues: 'Flat hips • Quick drive • Inhale rhythm • Exhale drive'
      },
    ]
  },
  {
    ...
    exercises: [
      {
        name: 'Walk/Yoga Flow',
        sets: '20–30 min', rpe: 'Recovery', weight: '',
        video: 'https://youtu.be/v7AYKMP6rOE',
        cues: 'Slow moves • Breathe deep • Inhale lengthen • Exhale release'
      },
      {
        name: 'Mobility Work',
        sets: '15 min', rpe: 'Joint focus', weight: '',
        video: 'https://youtu.be/FSSDLDhbacc',
        cues: 'Controlled stretch • No bounce • Inhale prep • Exhale deepen'
      },
      {
        name: 'Core Circuit (opt)',
        sets: '2 rounds', rpe: 'Plank variations', weight: '',
        video: 'https://youtu.be/ASdvN_XEl_c',
        cues: 'Steady pace • Good form • Inhale brace • Exhale rep'
      },
    ]
  }
];
